...
&emsp;处理：  
&emsp;&emsp;(1)&emsp;删除并封禁3天。  
&emsp;&emsp;(2)&emsp;删除并封禁3天。  
...
(4)&emsp;普通吧友发表大量情绪化内容。（≥2帖/周）  
&emsp;处理：  
&emsp;&emsp;(1)&emsp;删帖。违背(7.)者同样适用(7.)列举的处罚。涉政次数累计达2次者，取消吧务资格。  
&emsp;&emsp;(2)&emsp;不会删帖。  
&emsp;&emsp;(3)&emsp;删帖。今后该小号进行发言视同用大号发言。  
&emsp;&emsp;(4)&emsp;警告。屡教不改者封禁1天。
