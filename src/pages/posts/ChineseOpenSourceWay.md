...
[^6]: 或者第二，视标准而定。
[^7]: 只是说 Clash 的可扩展性和可配置性好，而不是说它和它衍生产物的安全性好。例：[漏洞 1](https://web.archive.org/web/20220226105832/https://github.com/Fndroid/clash_for_windows_pkg/issues/2710)、[漏洞 2](https://web.archive.org/web/20230115024746/https://github.com/Fndroid/clash_for_windows_pkg/issues/3891)，亦可见博客作者对其[评价](https://o3o.ca/@21018365486/111341857762957393)。
